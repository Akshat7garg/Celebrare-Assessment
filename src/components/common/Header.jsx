...
function Header() {
    return (
        <header className="h-16 w-full fixed top-0 left-0 z-100 flex justify-around items-center border-b border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900">
